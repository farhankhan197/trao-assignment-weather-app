...
export default function HeroSection() {
  return (
    ...
    >
      ...
      >
        <p className="font-playfair text-sky-300/85 tracking-[7px] text-sm uppercase mb-1.5">
          मौसम
        </p>
        <h1 className="font-playfair font-black text-white leading-none tracking-tight"
...
/* Inline cloud shape helper — keeps Hero file self-contained */
function CloudShape({
  baseW, baseH, color,
  bumps,
}: {
