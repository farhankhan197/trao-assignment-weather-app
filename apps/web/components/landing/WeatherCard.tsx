...
export default function WeatherCard({ icon, temp, city, desc, delay = 0 }: WeatherCardProps) {
  return (
    ...
    >
      ...
      <div className="font-display text-lg sm:text-xl lg:text-2xl font-bold text-white leading-none">{temp}°</div>
      <div className="text-[9px] sm:text-[10px] lg:text-[11px] text-white/50 mt-0.5 sm:mt-1 tracking-wide">{city}</div>
