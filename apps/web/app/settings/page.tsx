          ...
          <div className="flex flex-col sm:flex-row items-start justify-between gap-4 sm:gap-6">
            <div>
              ...
              <p className="text-[var(--text-muted)] text-sm max-w-md">
                Connect your Google Calendar to get weather alerts for upcoming events with
                locations. We only request read-only access.
              </p>
              {calendarConnected && googleEmail && (
                <p className="text-[var(--text-muted)] text-sm mt-2">
                  Currently connected as{' '}
                  <span className="text-[var(--text-secondary)]">{googleEmail}</span>
                </p>
              )}
            </div>
